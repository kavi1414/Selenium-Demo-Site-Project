...
public class WindowsExample {
    ...
    public void WindowExample() throws InterruptedException {
        ...
        //Anthmt open une child window ekne ek close krnawa driver.close(); eken wenne dnt open okkm windows open krnwa
...
//Methn expath ek klin test kala elemnt ekak xpath ekak
        //Me element ek web page eke tyenwd ahnwa



        //2)First methode using Foreach Loop
