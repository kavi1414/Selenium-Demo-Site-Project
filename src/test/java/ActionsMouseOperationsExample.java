...
public class ActionsMouseOperationsExample {
    ...
    public void MouseOperationsTest() throws InterruptedException {
        ...
        actions.moveToElement(driver.findElement(By.id("menuform:j_idt37"))).perform(); //build().performe() wdhtath plwan performe() thu bild ek tyen nis performe() wtrk tibth hri
        Thread.sleep(2000);
        actions.moveToElement(driver.findElement(By.id("menuform:j_idt38"))).perform(); //build().performe() wdhtath plwan performe() thu bild ek tyen nis performe() wtrk tibth hri
        Thread.sleep(2000);
        actions.moveToElement(driver.findElement(By.id("menuform:j_idt39"))).perform(); //build().performe() wdhtath plwan performe() thu bild ek tyen nis performe() wtrk tibth hri
        Thread.sleep(2000);
